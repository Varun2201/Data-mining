...
df = pd.read_csv('../data/match-details/2018.csv')
df.head()
...
df1 = pd.read_csv('../data/drafting/International_2018_drafting.csv')
final = []
df1.head()
...
file1 = open('../output/Tournament-Analysis-2018.txt','w')
